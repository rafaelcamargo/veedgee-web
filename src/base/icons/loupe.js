  ...
  return (
    <Icon {...props} name="loupe">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 40 40">
        <path fill="#717C84" d="M18.2,13c2.87,0,5.2,2.33,5.2,5.2s-2.33,5.2-5.2,5.2S13,21.07,13,18.2S15.33,13,18.2,13 M18.2,11c-3.98,0-7.2,3.22-7.2,7.2s3.22,7.2,7.2,7.2s7.2-3.22,7.2-7.2S22.18,11,18.2,11L18.2,11z"/>
